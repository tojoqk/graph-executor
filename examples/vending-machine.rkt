...
(module+ test
  ...
  (check-equal? (find-witness m (lambda ([n : Node-Info] st)
                ...
                (apply journal `(,(journal-entry 'choose "Go to Vending Machine")
                                 ,(journal-entry 'choose "Insert Money" #:prompt-records (list (prompt-record 1)))
                                 ,@(make-list 299 (journal-entry 'choose "Insert More" #:prompt-records (list (prompt-record 1))))
                                 ,(journal-entry 'choose "Purchase Drink (150 Yen)")
                                 ,(journal-entry 'auto "Dispense Done (Remaining Inserted)")
                                 ,(journal-entry 'choose "Press Return Lever")
                                 ,(journal-entry 'auto "Change Dispatched")
                                 ,(journal-entry 'choose "Walk Away")
                                 ,(journal-entry 'choose "Sit on Bench"))))
  ...
  (check-equal? (let loop : (Option Journal) ([depth : Natural 0])
                ...
                (journal (journal-entry 'choose "Go to Vending Machine")
                         (journal-entry 'choose "Insert Money" #:prompt-records (list (prompt-record 150)))
                         (journal-entry 'choose "Purchase Drink (150 Yen)")
                         (journal-entry 'auto "Dispense Done (Just Zero)")
                         (journal-entry 'choose "Walk Away")
                         (journal-entry 'choose "Sit on Bench"))))
