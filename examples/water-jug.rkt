...
(module+ test
  ...
  (check-equal? (shortest-path (make-model '(3 5 7) 1))
                (journal (choose-journal-entry "Fill 3G")
                         (auto-journal-entry "Not yet")
                         (choose-journal-entry "Fill 5G")
                         (auto-journal-entry "Not yet")
                         (choose-journal-entry "Pour 3G -> 7G")
                         (auto-journal-entry "Not yet")
                         (choose-journal-entry "Pour 5G -> 7G")
                         (auto-journal-entry "Clear!"))))
